...
import logging
log = logging.getLogger("zen.MSSQLServer")

from Products.ZenModel.ZenPack import ZenPackBase
class ZenPack(ZenPackBase):
    """
    ZenPacks.zenoss.MSSQLServer ZenPack loader.
    """

    # Windows services for which we want to enable for monitoring by default.
    defaultWinServices = (
            'MSSQLSERVER', 'MSSQLServerOLAPService', 'MsDtsServer',
            'ReportServerSvc', 'SQLBrowser', 'SQLSERVERAGENT', 'SQLServer',
            'SQLWriter', 'msftesql')
